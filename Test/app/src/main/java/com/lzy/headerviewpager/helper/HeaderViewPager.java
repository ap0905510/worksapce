package com.lzy.headerviewpager.helper;
...
public class HeaderViewPager extends LinearLayout {
    ...
    private int topOffset = dpToPx(80); //0;      //滚动的最大偏移量
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.e("YW", "currentY: " + currentY + " shiftX: " + shiftX + " shiftY: " + shiftY + " mTouchSlop: " + mTouchSlop);
                /**
