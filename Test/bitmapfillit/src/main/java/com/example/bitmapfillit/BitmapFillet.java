...
public class BitmapFillet {
     ...
     * @return
     */
    public static Bitmap canvasTriangle(Bitmap bitmapImg, int roundPx, int direct) {
        if (roundPx <= 0) {
            roundPx = 8;
        }
