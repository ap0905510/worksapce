...
import com.yw.progressbarview.R;
...
public class RoundProgressBarWithProgress extends HorizontalProgressBar {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        int textHeight2 = (int) ((mPaint.descent() - mPaint.ascent()));

        Log.e("xx", "mPaint.descent() = " + mPaint.descent() + " ;mPaint.ascent() = " + mPaint.ascent());
        Log.e("xx", "textHeight = " + textHeight + " ;textHeight2 = " + textHeight2 + " ;textWidth = " + textWidth);
