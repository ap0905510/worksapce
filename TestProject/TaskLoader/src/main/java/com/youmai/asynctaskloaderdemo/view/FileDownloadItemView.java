package com.youmai.asynctaskloaderdemo.view;
...
import com.youmai.asynctaskloaderdemo.utils.DisplayUtil;
...
public class FileDownloadItemView extends LinearLayout {
    ...
    private void initLayout(Context context) {
        ...
        LayoutParams params = new LayoutParams(DisplayUtil.dip2px(context, 40), DisplayUtil.dip2px(context, 40));
