...
import com.yw.heightlight.interfaces.HighLightInterface;
import com.yw.heightlight.position.OnBottomPosCallback;
import com.yw.heightlight.position.OnLeftPosCallback;
import com.yw.heightlight.position.OnRightPosCallback;
import com.yw.heightlight.position.OnTopPosCallback;
import com.yw.heightlight.shape.BaseLightShape;
import com.yw.heightlight.shape.CircleLightShape;
import com.yw.heightlight.shape.OvalLightShape;
import com.yw.heightlight.shape.RectLightShape;
...
//                })
                ...
                .setOnShowCallback(new HighLightInterface.OnShowCallback() {
                    //监听显示回调
                    @Override
                    public void onShow(Object hightLightView) {
                        if (hightLightView instanceof HightLightView) {
